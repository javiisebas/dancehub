...
export class ConnectedAccountRepositoryImpl
    extends BaseRepository<ConnectedAccount, typeof connectedAccounts>
    implements IConnectedAccountRepository
{
    protected readonly table = connectedAccounts;
    protected readonly entityName = 'ConnectedAccount';
