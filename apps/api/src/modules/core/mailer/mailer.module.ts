...
import { CreateEmailLogHandler } from './application/commands/create-email-log/create-email-log.handler';
import { UpdateEmailLogHandler } from './application/commands/update-email-log-status/update-email-log.handler';
...
import { FindFailedOrStuckEmailLogsHandler } from './application/queries/find-failed-or-stuck-email-logs/find-failed-or-stuck-email-logs.handler';
...
import { EmailLogRepositoryProvider } from './infrastructure/repositories/email-log.repository';
...
const Repositories: Provider[] = [EmailLogRepositoryProvider];
